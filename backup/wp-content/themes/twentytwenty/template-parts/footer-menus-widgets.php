				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="white-font">
							<h3 class="">
								Get Update by
								<span class="line-break-before">
									<span class="text-gradient">sign up </span>newsletter
								</span>
							</h3>
						</div>
					</div>
					<div class="col-md-5">
						<form>
							<div class="newsletter-input-div input-group">
								<input placeholder="Enter your email" class="form-control">
								<button type="button" id="button-addon2" class="newsletter-form-btn btn btn-primary">Notify me</button>
							</div>
						</form>
					</div>
					<div class="col-md-1">
				...
				<aside class="footer-widgets-outer-wrapper">
					...
					<div class="footer-widgets-wrapper">
						...
						<?php if ($has_sidebar_1) { ?>
							...
							<div class="footer-widgets column-one grid-item custom-sidebar">
						...
						<?php if ($has_sidebar_2) { ?>
							...
							<div class="footer-widgets column-two grid-item custom-sidebar">
